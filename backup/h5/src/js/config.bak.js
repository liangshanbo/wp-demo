...
(function(global, undef) {
  ...
  if (isBrowser) {
    ...
    var maps = {
      'm-pre.gomeplus.com': 'js-pre.meixincdn.com',
      'm.gomeplus.com': 'js.meixincdn.com'
    };
    var scripts = document.querySelectorAll('script');
    basepath = location.href.match(/^(http[s]?):\/\/(?:[^\/]*)\/.*$/)[1] + '://' + maps[location.host] + "CDN8027";
    ...
    publicpath = (maps[location.host]? location.href.match(/^(http[s]?):\/\/(?:[^\/]*)\/.*$/)[1]+'://' + maps[location.host] : 'https://js-pre.meixincdn.com') + '/m/public';
  ...
  var mod = {
    ...
    publicpath : debug ? publicpath + "/gomeplusJS/src/" : publicpath + '/gomeplusJS/dist/',
    publicdeps : {
      "vendors/zepto.js" : {
