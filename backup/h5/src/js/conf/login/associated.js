...
define('conf/login/associated.js', function (require, exports, module) {
    ...
    var bindEvents = function bindEvents() {
        ...
        next.on('click', function () {
            ...
            var userInfo = storage.getItem('ascToken');
            var obj = {
                "mobile": mobile,
    ...
    //下一步按钮高亮
    var nextHigh = function nextHigh() {
    ...
    //提交注册信息
    var fblogSub = function fblogSub(obj) {
        ajax.post({
...
//# sourceMappingURL=../../../maps/conf/login/associated.js.map
