...
define("utils/appCall", function (require, exports, module) {
    ...
    var callH5 = function callH5(params) {
    ...
    var callApp = function callApp(params) {
        if (!params || !params["url"]) {
            return;
        }
    ...
    var call = function call(src) {
        if (Mobile.isAndroid) {
            var ua = navigator.userAgent.toLowerCase();
            if (ua.indexOf("samsung") > 0) {
                //单独处理三星手机
                location.href = src;
            } else {
    ...
    module.exports = { callH5: callH5, callApp: callApp };
});
//# sourceMappingURL=../../maps/utils/appCall.js.map
